...
class Signals
{
     ...
     * @param int $devup
     * @param int $devdn
     * @return int This algorithm uses the talib Bollinger Bands function to determine entry entry
     *
     ...
     * @param int $period2
     * @param int $period3
     * @return int Moving Average Crossover Divergence (MACD) indicator as a buy/sell signal.
     *
     ...
     * @param null $data
     * @param int $period
     * @param float|int $acceleration
     * @param float|int $maximum
     * @return int Parabolic Stop And Reversal (SAR)
     *
     ...
     * @param float|int $maximum
     * @return int This is a forex version of SAR which is used with Stoch.
     *
